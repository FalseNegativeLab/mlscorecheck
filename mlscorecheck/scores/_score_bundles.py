...
score_function_complement_functions = {
    key: score_functions_all[key] for key in ["err", "fdr", "for_", "fnr", "fpr"]
}
...
score_function_standardized_complement_functions = {
    key: score_functions_standardized_all[key] for key in ["err", "fdr", "for_", "fnr", "fpr"]
}
...
# the alias mapping
score_function_aliases = {"tpr": "sens", "tnr": "spec", "prec": "ppv", "rec": "sens", "f1": "f1p"}
