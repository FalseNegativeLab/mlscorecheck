...
setup(name=DISTNAME,
        ...
        package_data={'mlscorecheck': [os.path.join('individual', 'solutions.json'),
                                        ...
                                        os.path.join('experiments', 'machine_learning', 'ehg.json'),
                                        os.path.join('experiments', 'computer_vision', 'drive', 'drive_test_fov.json'),
                                        os.path.join('experiments', 'computer_vision', 'drive', 'drive_test_no_fov.json'),
                                        os.path.join('experiments', 'computer_vision', 'drive', 'drive_train_fov.json'),
                                        os.path.join('experiments', 'computer_vision', 'drive', 'drive_train_no_fov.json'),
                                        os.path.join('experiments', 'computer_vision', 'isic2016.json'),
                                        os.path.join('experiments', 'computer_vision', 'isic2017m.json'),
                                        os.path.join('experiments', 'computer_vision', 'isic2017sk.json'),]},
